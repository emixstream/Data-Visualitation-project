...
risultati <- read.csv2("C:\\Users\\emanu\\OneDrive\\Desktop\\R scripts\\prima viz.csv")
...
dati_prop$prop <- as.numeric(dati_prop$prop) #da factor a numeric
...
upper <- c(0.68, 0.68, 0.44, 0.44, 0.44, 0.44, 0.48, 0.48, 0.68, 0.68, 0.48, 0.48)
lower <- c(0.32, 0.32, 0.10, 0.10, 0.10, 0.10, 0.13, 0.13, 0.32, 0.32, 0.13, 0.13)
